...
import { Platform, StatusBar as RNStatusBar, StatusBarAnimation } from "react-native";
import { NativeModule } from "./module";
import {StatusBarProps, SystemBarStyle} from "./types";
...
export class StatusBar extends React.Component<StatusBarProps> {
  ...
  static currentHeight = RNStatusBar.currentHeight;
  ...
  static setBarStyle(style: SystemBarStyle, animated?: boolean): void {
    ...
    if ((style === "light-content" || style === "dark-content") && oldProps?.barStyle !== style) {
      if (Platform.OS === "android") {
        NativeModule?.setStatusBarStyle(style);
      } else {
        RNStatusBar.setBarStyle(style, animated);
      }
      const newEntry = createStackEntry({animated, barStyle: style});
      StatusBar.mergedProps = {...newEntry};
    }
  }
